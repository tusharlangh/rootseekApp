...
const ThemeThread = () => {
  ...
  const sorted = [
    {
      ...
      dates: [..._progression["dates"]].reverse(),
      growthRole: [..._progression["growth_role"]].reverse(),
      emojis: [..._progression["emoji"]].reverse(),
    },
    {
      summary: [..._progression["summary"]],
      dates: [..._progression["dates"]],
      growthRole: [..._progression["growth_role"]],
      emojis: [..._progression["emoji"]],
    },
  ];
  ...
  return (
    <SelectedContext.Provider value={{ selectedSort, setSelectedSort }}>
      <LinearGradient
        ...
        <SafeAreaView edges={["top", "left", "right"]}>
          ...
          >
            ...
            <View style={{ paddingHorizontal: 16 }}>
              {sorted[selectedSort].growthRole.map((_, index) => (
                <View key={index}>
                  <Card
                    summary={sorted[selectedSort].summary[index]}
                    date={sorted[selectedSort].dates[index]}
                    growth_role={sorted[selectedSort].growthRole[index]}
                    emoji={sorted[selectedSort].emojis[index]}
                  />
                </View>
              ))}
            </View>
