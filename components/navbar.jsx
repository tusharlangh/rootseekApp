...
export const HideTabBar = createContext();
            ...
            <Tab.Navigator
              tabBar={(
                ...
                <>
                  <LinearGradient
                    pointerEvents="none"
                    colors={hideTabBar ? antiGradient : gradients}
                    start={{ x: 0, y: 1 }}
                    end={{ x: 0, y: 0 }}
                    style={{
                      position: "absolute",
